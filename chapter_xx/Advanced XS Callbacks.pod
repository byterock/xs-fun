...
Well this was the first Driver for DBI a tool so common we hardly wvern think about using it. Just think
the arectecute of this little program hasn't changed that much shince it was first introducred 20 years ago 
and it still going strong so something mush be right with it. 

Now to undersand the patch a little intro to the archetcure of this moduel would help out some and give you an idea how a larger
